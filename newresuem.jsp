...
<form style="height:100%" name="form4" method="post" action="resuemin.jsp">
	<div class="container" style="height:1500px;">
	
		<div class="loan-col" style="height:100%;">
			<h3>添加简历</h3>
			<h4>您还没有简历，现在添加一份简历吧！</h4>
			
			<div class="col-loan" style="float:left; width:600px">
				<ul class="loan-col1" style="width:100%">
					<li ><span>姓名 </span></li><label>:</label>
					<li class="loan-list-top"><input type="text" name="uname" value="" placeholder="" required=""></li>
				</ul>
				<ul class="loan-col1">
				...
				<ul class="loan-col1">
					...
					<li class="loan-list-top"><input type="text" name="umajor" value="" placeholder="" required=""></li>
				</ul>
				<ul class="loan-col1">
					<li ><span>联系电话 </span></li><label>:</label>
					<li class="loan-list-top"><input type="text" name="utel" value="" placeholder="" required=""></li>
				</ul>
				
				<ul class="loan-col1">
					<li ><span>邮箱地址</span></li><label>:</label>
					<li class="loan-list-top"><input type="text" name="other" value="" placeholder="" required=""></li>
				</ul>
				
			</div>
			<div class="picup" style="float:left;width: 440px;height: 354px;position:relative">
				<h4>简历照片上传</h4>
				<img class="img-responsive" style="position:absolute; left:15%;border: 4px solid #A3A3A3;height:200px;width:200px" src="images/avt.png" alt="">
				<br><br>
				<input style="position:absolute; top:280px;left:15%;" type="file" name="upic" value="" placeholder="" required="">
			</div>
			<!---->
