...
String edux = request.getParameter("edux");
...
try {
	...
	file=rs.getString("file");
     str = "delete from resuem where resuem.ruser="+name+" ";
	
	stmt.execute(str);
	String sql = "insert into resuem values("+maxid+",'"+name+"','"+uname+"','"+usex+"','"+ubirthday+"','"+ubirthmon+"','"+ubirthyear+"','"+edu+"','"+umajor+"','"+utel+"','"+other+"','"+edux+"','"+jobx+"','"+file+"')";
